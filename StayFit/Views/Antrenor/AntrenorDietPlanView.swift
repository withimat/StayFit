...
struct AntrenorDietPlanView: View {
    let student: Student
    ...
    var body: some View {
        NavigationStack {
            VStack {
                Form {
                    Text("Öğrencinize vereceğiniz diyet planının detaylarını buraya giriniz.")
                    Section {
            ...
            .navigationBarTitle("Diyet Planı Hazırla")
...
#Preview {
    AntrenorDietPlanView(student: Student(id: "12", memberId: "12", endDate: "11/21", amount: 5500, height: 180, weight: 80, firstName: "İmat", lastName: "Gokaslan", gender: 0, birthDate: "15/08", photoPath: "", goal: ""))
}
